          ...
          <div className="absolute top-full right-0 mt-2 w-80 bg-dark-800 border border-dark-600 rounded-lg p-4 shadow-xl z-50 animate-fade-in-up">
            ...
            <div className="space-y-2 text-xs text-dark-400">
              <div className="flex items-start gap-2">
                ...
                <p><span className="text-dark-200 font-medium">With API key:</span> 4 tools use real Claude AI for severity assessment, counter-offers, negotiation, and justification.</p>
              </div>
              <div className="flex items-start gap-2">
              ...
              <div className="mt-2 p-2 bg-dark-900 rounded text-[11px] text-dark-500">
                Get a key at console.anthropic.com. Key stays in-browser only.
              </div>
            </div>
          </div>
        )}
